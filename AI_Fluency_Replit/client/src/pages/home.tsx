...
export default function Home() {
  ...
  useEffect(() => {
    // Load current module from localStorage
    const saved = localStorage.getItem('ai-course-current-module');
    if (saved) {
      try {
  ...
  // Save current module to localStorage when it changes
  useEffect(() => {
    localStorage.setItem('ai-course-current-module', currentModule);
  }, [currentModule]);
